...
| T7 | Modified dependency/action/build tooling substitutes a malicious artifact. | P3 locks build/audit tools, pins workflow actions and adds advisory/license/history/artifact/SBOM checks. Six license reviews block its gate. | [P3 scope](SUPPLY_CHAIN.md); R1 handoff/publisher qualification and actual controls; R2 provenance and release acceptance. |
