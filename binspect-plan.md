...
figure Python. **R3 maintenance/recovery tooling and local exercises are implemented; policy
acceptance, integration and schedule activation remain pending.** See
[R3 evidence](docs/maintenance-recovery-review.md). **Next phase: R2 readiness/evidence
review; publication remains blocked by outstanding acceptance and qualification.** A3 allocates
